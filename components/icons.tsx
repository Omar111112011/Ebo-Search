...
export const SparkleIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className={className}>
        ...
        <path d="M5.26 17.242a.75.75 0 10-1.06-1.06 7.5 7.5 0 00-1.996 5.662a.75.75 0 00.75.75h2.5a.75.75 0 000-1.5h-1.372c.04-.32.09-.636.148-.942zM18 19.5a.75.75 0 100-1.5 .75.75 0 000 1.5z" />
    </svg>
);
